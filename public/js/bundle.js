...
},{"./es6.array.iterator":"../../node_modules/core-js/modules/es6.array.iterator.js","./_object-keys":"../../node_modules/core-js/modules/_object-keys.js","./_redefine":"../../node_modules/core-js/modules/_redefine.js","./_global":"../../node_modules/core-js/modules/_global.js","./_hide":"../../node_modules/core-js/modules/_hide.js","./_iterators":"../../node_modules/core-js/modules/_iterators.js","./_wks":"../../node_modules/core-js/modules/_wks.js"}],"alert.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return fetch("".concat(location.protocol, "//").concat(location.host, "/api/v1/users/login"), {
              method: 'POST',
              headers: {
          ...
          case 6:
            ...
            if (response.status === 'success') {
              ...
              (0, _alert.showAlert)('error', response.message);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch("".concat(location.protocol, "//").concat(location.host, "/api/v1/users/logout"), {
              method: 'GET'
            });
...
},{"./alert":"alert.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJ1ZWJhMjEyMTIiLCJhIjoiY2w4NHAxYWhvMGJqajNucXk1NTRuNmV6cCJ9.3SnRpufoghlfV-zHBb9YvA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup().setLngLat(loc.coordinates).setHTML("<p> ".concat(loc.day, " : ").concat(loc.description, "</p>")).addTo(map);
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var baseUrl, url, updateData, response, dataResponse;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            baseUrl = "".concat(location.protocol, "//").concat(location.host, "/api/v1/users");
            url = type === 'password' ? "".concat(baseUrl, "/updateMyPassword") : "".concat(baseUrl, "/updateMe");
            updateData = data;
            _context.next = 6;
            return fetch(url, {
              method: 'PATCH',
          ...
          case 9:
            ...
            if (dataResponse.status === 'success') {
              (0, _alert.showAlert)("success ".concat(type.toUpperCase()), 'Data changed succesfully');
            }
...
},{"./alert":"alert.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51LkrxWEpFVJfquSbg1RuJhFKHeiBFxmR30w2Pc9XEFTMKJ0imjjjnDNXGwZmzIZDOyFHcBVCO76RTiQG9vFX3Cia00hDF909wo');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("".concat(location.protocol, "//").concat(location.host, "/api/v1/bookings/checkout-session/").concat(tourId));
...
var bookButton = document.querySelector('#book-tour');
